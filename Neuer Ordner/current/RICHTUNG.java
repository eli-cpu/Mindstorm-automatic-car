...
public class RICHTUNG {
    ...
    private void StartBickrichtungSetzen(String NextPosi) {
        ...
        if(orte[xPos][yPos-2].equals(NextPosi)) {
            blickrichtung = "N";
            yPos-=2;
        }
        else if(orte[xPos+2][yPos].equals(NextPosi)) {
            blickrichtung = "O";
            xPos+=2;
        }
        else if(orte[xPos][yPos+2].equals(NextPosi)) {
            blickrichtung = "S";
            yPos+=2;
        }
        else if(orte[xPos-2][yPos].equals(NextPosi)) {
        ...
        for (int i=2; i <= laenge-1; i++) {
            switch (blickrichtung) {
              case "N":
                  ...
                  else if(Vergleich(xPos, yPos-2, AusgabeList(Weg, i)) && !(Vergleich(xPos, yPos-1, AusgabeList(Weg, i)))) {
                      blickrichtung = "N";
                      yPos = yPos-2;
                      Richtungen.add("m");
                  }
                  ...
                  else if(Vergleich(xPos+2, yPos, AusgabeList(Weg, i)) && !(Vergleich(xPos+1, yPos, AusgabeList(Weg, i)))) {
                      blickrichtung = "O";
                      xPos = xPos+2;
                      Richtungen.add("r");
                  }
              ...
              case "S":
                  if(Vergleich(xPos, yPos+1, AusgabeList(Weg, i))) {
                    ...
                    else if(Vergleich(xPos-2, yPos, AusgabeList(Weg, i)) && !(Vergleich(xPos-2, yPos, AusgabeList(Weg, i)))) {
                        blickrichtung = "W";
                        xPos = xPos-2;
                        Richtungen.add("r");
                    }
